namespace AkaBIWebSite.Infrastructure
{
    public static class Constants
    {
        ...
        public const string GetAllPagePostsUrlFormat = "{0}/posts?fields=created_time,message,id,full_picture,picture,description,link,permalink_url,likes,shares&limit=10";
